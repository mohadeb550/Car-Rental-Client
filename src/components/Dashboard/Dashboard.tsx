...
const Dashboard = () => {
  ...
  <div className="drawer-content flex flex-col ">
   ...
   {/* <Toaster/> */}
    ...
    <label htmlFor="my-drawer-2" className="text- drawer-button lg:hidden"> <MdOutlineMenu size={24} /> </label>
    </div>
  ...
  <div className="drawer-side ">
    ...
    <ul className="menu p-4 w-80 min-h-full bg-[#000209] text-base-content pt-10">
