...
const UserSidebar = () => {
  ...
  <li>
       <NavLink to="/dashboard/user-overview" className={({isActive})=> isActive? 'flex items-center p-2 text-amber-400 inter-regular': 'flex items-center p-2 text-gray-200 rounded-lg ' }>
