    ...
    return (
        <div>
            ...
            <div className="h-[280px] md:h-[160px] lg:h-[240px] xl:h-[330px]">
                <img src={image} style={{borderRadius: '60px'}} className="w-full h-full object-cover opacity-75 px-7 py-6 md:px-4 md:py-3 lg:px-6  lg:py-7 xl:px-12 xl:py-10" />
             </div>

            <div className="border-l-2 border-gray-600 px-6 md:px-4 lg:px-7 xl:px-12 py-2 xl:py-5 pb-1 ml-9  border-t-2 rounded-3xl">
