  ...
  <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
    <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
      <div className="overflow-hidden">
        <table
          ...
          <thead className=" inter-regular ">
           ...
           Status
              ...
              <th scope="col" className="border-r px-6 py-0 md:py-2 lg:py-4 border-zinc-600">Approve </th>
            
            <th scope="col" className="border-r border-zinc-600 px-6 py-0 md:py-2 lg:py-4  ">Cancel</th>
              
            
              <th scope="col" className=" px-6 py-0 md:py-2 lg:py-4  rounded-r-2xl">  Edit </th>
          
            </tr>
          </thead>
          <tbody className="relative">

          {bookingsLoading && <ClipLoader
           color='#FBBF24'
          ...
          {bookings?.map(booking =>  <tr key={booking._id} className="border-b ">
              <td
                ...
                <img src={booking?.car?.images[0]} className="w-[52px] h-[52px] md:w-16 md:h-16 object-contain rounded-full" />
              </td>
              <td
          ...
          {booking.status === 'cancelled'? <></> : <><td className="whitespace-nowrap font-medium border-r text-sm md:text-lg  px-6 py-4 border-zinc-500">
        ...
        {!bookings?.length && <p className="text-xl text-center mt-44 text-gray-500"> No Bookings </p>}
      </div>
    </div>
  </div>
</div>
