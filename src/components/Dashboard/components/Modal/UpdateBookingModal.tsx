  ...
  return (
    <section className="w-screen h-screen fixed top-0 left-0 right-0 bottom-0 z-50  bg-black/30 backdrop-blur-sm flex justify-center items-center overflow-y-auto">  
      ...
      <section className="flex items-center gap-4">
        ...
        <input type="text" className="outline-none border-b-2 border-gray-700 focus:border-blue-600 w-full py-1 rounded-sm" {...register("phone")} />
        </div>

        <div className="flex flex-col justify-start items-start mb-3">
        <label className="font-semibold">Date</label>
        <input type="date" className="outline-none border-b-2 border-gray-700 focus:border-blue-600 w-full py-1 rounded-sm" {...register("date")} />
        </div>

        <div className="flex flex-col justify-start items-start mb-3">
        <label className="font-semibold">Start time </label>
        <input type="time" className="outline-none border-b-2 border-gray-700 focus:border-blue-600 w-full py-1 rounded-sm" {...register("startTime")} />
        </div>
